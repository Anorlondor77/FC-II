...
%% FFT + fftshift + eix k coherent
N = length(xa);
[X, k] = FuncioTFZP(xa, fs, N);
...
%% Zero padding (augment de resolució freqüencial)
factorZP = 16;
[Xzp, kzp] = FuncioTFZP(xa, fs, factorZP*N);
...
%% Enventanat: rectangular, hamming, triangular
f0 = 100.5e3;
Nw = 1024;
tw = (0:Nw-1)/fs;
xw = sin(2*pi*f0*tw);
